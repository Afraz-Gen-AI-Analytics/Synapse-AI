...
// FIX: Added explicit type `CampaignAsset` to the parameter `a` to resolve 'property does not exist on type unknown' error.
    ...
    return (
        <div className="flex flex-col md:h-full bg-slate-900/50 rounded-xl border border-slate-800/80 shadow-2xl shadow-black/30 p-6 sm:p-8 md:overflow-hidden backdrop-blur-sm">
                ...
                {step === 3 && strategy && (
                     <div className="animate-fade-in-up">
                        ...
                        <div className="space-y-12">
                         ...
                         {!isGeneratingAssets && (
                             <div className="mt-10 pt-8 border-t border-slate-700 text-center flex justify-center items-center gap-4">
