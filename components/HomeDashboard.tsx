                    ...
                    <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-900 to-slate-950 rounded-xl border border-slate-800/80 shadow-2xl shadow-black/30 p-6">
                        ...
                        <div className="flex-1 space-y-3">
                           {agents.length > 0 ? agents.slice(0, 2).map(agent => (
                               ...
                               <p className="text-sm text-slate-500 text-center pt-4">No agents deployed.</p>
                           )}
                        </div>
                    </div>
                    <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-900 to-slate-950 rounded-xl border border-slate-800/80 shadow-2xl shadow-black/30 p-6">
                       <div className="flex items-center mb-4">
                         ...
                         <div className="flex-1 space-y-3">
                           {history.length > 0 ? history.map(item => (
                               <div key={item.id} className="bg-slate-800/50 p-3 rounded-md">
                               ...
                               <p className="text-sm text-slate-500 text-center pt-4">No recent history.</p>
                           )}
                        </div>
                    </div>
                </div>
